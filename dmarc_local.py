...
def process_local_file(file_path: str, analyzer: DMARCAnalyzer) -> None:
    """
    Process a single DMARC report file directly (XML or JSON)
    ...
    try:
        ...
        if report_data:
            ...
            process_dmarc_report(report_data, os.path.dirname(file_path), analyzer)
        else:
...
def process_local_files() -> None:
    ...
    try:
        ...
        for file_path in xml_files:
            ...
            try:
                process_local_file(file_path, dmarc_analyzer)
                successful_count += 1
            except Exception as e:
        ...
        if successful_count > 0:
            ...
            logging.warning("No files were successfully processed - skipping combined report")
